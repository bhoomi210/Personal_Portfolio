  ...
  return (
    ...
    >
        <div className='container mx-auto px-6'>
           ...
           <p className='text-gray-400 text-center max-w-2xl mx-auto mb-16'>Have a Project in mind to collaborate? Let's talk!</p>
              ...
              <div className='space-y-8'>
                 <div className='flex items-start'>
                     ...
                     <div>
                        ...
                        <p className='text-gray-400'>Navrangpura, Ahemdabad</p>
                     </div>
                 </div>
                 ...
                 <div className='flex items-start'>
                     ...
                     <div>
                        ...
                        <p className='text-gray-400'>bhumirpurohit@gmail.com</p>
                     </div>
                 </div>
                 ...
                 <div className='flex items-start'>
                     ...
                     <div>
                        ...
                        <p className='text-gray-400'>+91 9327938532</p>
                     </div>
                 </div>
               ...
               <div className='pt-4'>
                 ...
                 <div className='flex space-x-4'>
                    ...
                    <a href='#' className='w-12 h-12 rounded-full
                    bg-dark-300 flex items-center justify-center text-orange-400
                    hover:bg-orange-400 hover:text-white transition duration-300'>
                     <FaLinkedin/>
                    </a>

                    <a href='#' className='w-12 h-12 rounded-full
                    bg-dark-300 flex items-center justify-center text-blue-400
